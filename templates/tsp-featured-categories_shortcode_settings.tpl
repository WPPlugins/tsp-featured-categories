...
<ul style="list-style-type:square; padding-left: 30px;">
	...
	<li>Category Taxonomy: <strong>taxonomy="category"</strong></li>
	...
	<li>Show Text Categories: <strong>show_text_categories="Y"</strong>(Options: Y, N)</li>
...
<strong>[tsp-featured-categories title="Featured Categories" title_pos="below" number_cats="3" taxonomy="category" shrink_fit="Y" cat_ids="5,3,4" cat_type="all" show_text_categories="Y" hide_empty="Y" hide_desc="N" max_desc="60" layout="0" parent_cat="3" box_width=500 box_height=300 order_by="count" thumb_width="80" thumb_height="80" before_title="" after_title=""]</strong>
