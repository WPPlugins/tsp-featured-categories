...
$easy_dev_data = get_plugin_data( WP_PLUGIN_DIR . "/tsp-easy-dev/tsp-easy-dev.php", false, false );
$easy_dev_version = $easy_dev_data['Version'];
...
else if (version_compare($easy_dev_version,'1.3.5', '<'))
{
    function display_tspfc_notice()
    {
        $message = TSPFC_PLUGIN_TITLE . ' <strong>was not installed</strong>, plugin requires the installation of at least version 1.3.5 of <strong><a href="plugin-install.php?tab=search&type=term&s=TSP+Easy+Dev">TSP Easy Dev</a></strong>.';
        ?>
        <div class="error">
            <p><?php echo $message; ?></p>
        </div>
